...
#define L_SRVC_FLAG_DOCKED_SERVICE_INSERTED_TO_TEMPQ 0x0001
#define L_MSSG_FLAG_FREE_EXTRA_DATA 0x0001
#define L_WORK_FLAG_QUIT 0x0001
#define L_MAST_FLAG_QUIT 0x0001
