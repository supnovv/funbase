...
L_EXTERN const l_byte* l_skip_chars_until_match_the_pattern(const l_string_pattern* patt, const l_byte* start, const l_byte* pend, const l_byte** last_match_start); /* return 0 - too short to match, otherwise success */
